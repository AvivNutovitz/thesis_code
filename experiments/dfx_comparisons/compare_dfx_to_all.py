...
for data_set_name in all_data_set_names:
    ...
    for model, model_name in zip(list_of_models, list_of_models_names):
        ...
        # dfx
        dx = DoeXai(x_data=new_X_train, y_data=y_train, model=model, model_name=model_name)
        ...
        # update mutual_information results
        ...
        # update permutation importance results
        ...
        # update random importance results
